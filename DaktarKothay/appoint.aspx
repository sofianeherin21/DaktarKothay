<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appoint.aspx.cs" Inherits="DaktarKothay.WebForm1" %>
...
<li><a href="home.aspx" class="active">Home</a></li>
    ...
    <div class="loginbox">
		...
		<asp: DataSourceID="SqlDataSource1">
            ...
            <asp:TextBox ID="TextPat" runat="server"></asp:TextBox>
			<p Style="color:chartreuse">Choose Day</p>
			<asp:DropDownList ID="DropDownList1" runat="server">
				

				
			</asp:DropDownList>
            <asp:Button ID="appointbtn" runat="server" Text="Submit"  OnClick="submit_Click" ></asp:Button>
			 
        </asp:>
		 <asp:Label ID="errorlabel" Style="background: transparent;color:red;font-size:20px" placeholder="" runat="server" Text=' '  ></asp:Label>
		 <asp:Label ID="submitlabel" Style="background: transparent;color:greenyellow;font-size:20px" placeholder="" runat="server" Text=' '  ></asp:Label>
		</form>
    </div>

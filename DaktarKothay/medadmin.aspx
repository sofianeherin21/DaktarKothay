...
<body>
	...
	<!-- ..............HEADER SESH............-->
	 ...
	 <div id="right" style="color: white;height:400px;width:100%; margin-left: 30%;margin-bottom:0px">
         

            <asp:GridView ID="GridView1" runat="server" style="width:500px; height:200px;margin-bottom:0 " AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="218px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
        ...
        <div style="margin: 0px 0px 0px 100px; color:white">

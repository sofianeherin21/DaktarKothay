<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userlogin.aspx.cs" Inherits="DaktarKothay.userlogin" %>
...
<body>
    ...
    <div class="loginbox">
        <img src="hosicon2.png" class="user" />
        <h2>User Login</h2>
        <form id="form1" runat="server">
            <p>Email</p>
            <asp:TextBox ID="TextUser" TextMode="Email" Style="background: transparent" placeholder="Enter Email" runat="server"></asp:TextBox>
            <p>Password</p>
